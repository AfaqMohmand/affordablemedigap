...
<head>
    ...
    <title>Affordable Medigap | Affordable Medicare | Medicare Supplement in USA</title>
    <style>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarDarkDropdownMenuLink">
                                ...
                                <li class="nav-item">
                                    <a href="medicareadvantage-plan-c.php" class="nav-link">Plan C</a>
                                </li>
                                <li class="nav-item">
                                    <a href="plan-d.php" class="nav-link">Plan D</a>
                                </li>
                                <li class="nav-item">
                                    <a href="medicare-plan-k.php" class="nav-link">Plan K</a>
                                </li>
                                <li class="nav-item">
                                    <a href="medicare-plan-L.php" class="nav-link">Plan L</a>
                                </li>
                                <li class="nav-item">
                                    <a href="medicare-plan-f.php" class="nav-link">Plan F</a>
                                </li>
                                <li class="nav-item">
                                    <a href="medicare-plan-g.php" class="nav-link">Plan G</a>
                                </li>
                                <li class="nav-item">
                                    <a href="medicare-plan-n.php" class="nav-link">Plan N</a>
                                </li>
                               
                            </ul>
                        </li>
                        <li class="nav-item">
                            <a href="new-medicare.php" class="nav-link">New medicare</a>
                        </li>

                        <li class="nav-item">
                            <a href="medigap-plan.php" class="nav-link">Medigap</a>
                        </li>
                        <li class="nav-item">
                            <a href="medicareadvantage-plan-c.php" class="nav-link">MedicareAdvantage</a>
                        </li>
                        <li class="nav-item">
                            <a href="plan-d.php" class="nav-link">Plan D</a>
                        </li>
